    ...
    <div class="container container-fluid">
        <div class="card shadow-sm">
            ...
            <div class="card-body text-center">
                <form action="{{ route('archProj.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" type="text" name="road" id="road" placeholder="road">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="row">
                        <div class="col-md-10 text-md-right">
                            <button type="submit" class="btn btn-outline-success">Add Project</button>
                        </div>
                    </div>
